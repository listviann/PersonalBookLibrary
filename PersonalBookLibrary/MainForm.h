...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->bookName_label->Text = L"Õ‡Á‚‡ÌËÂ ÍÌË„Ë";
			// 
			// bookName_textBox
			// 
			...
			this->authorName_label->Text = L"»Ïˇ ‡‚ÚÓ‡";
			// 
			// authorName_textBox
			// 
			...
			this->publisher_label->Text = L"»Á‰‡ÚÂÎ¸ÒÚ‚Ó";
			// 
			// publisher_textBox
			// 
			...
			this->libSection_label->Text = L"–‡Á‰ÂÎ";
			// 
			// libSection_textBox
			// 
			...
			this->origin_label->Text = L"œÓËÒıÓÊ‰ÂÌËÂ";
			// 
			// origin_textBox
			// 
			...
			this->assessment_label->Text = L"ŒˆÂÌÍ‡ ÍÌË„Ë";
			// 
			...
			this->existance_radioButton1->Text = L"≈ÒÚ¸ ‚ Ì‡ÎË˜ËË";
			...
			this->existance_radioButton2->Text = L"ÕÂÚ ‚ Ì‡ÎË˜ËË";
			...
			this->addToDb_button->Text = L"ƒÓ·‡‚ËÚ¸";
			...
			this->clearFields_button->Text = L"Œ˜ËÒÚËÚ¸";
			...
			this->ResultForm_ToolStripMenuItem->Text = L"¡‡Á‡ ‰‡ÌÌ˚ı";
			...
			this->HelpForm_ToolStripMenuItem->Text = L"œÓÏÓ˘¸";
			...
			this->bookExistance_groupBox->Text = L"Õ‡ÎË˜ËÂ";
			// 
			// rating_textBox
			// 
...
#pragma endregion
	...
	private: System::Void MainForm_Load(System::Object^ sender, System::EventArgs^ e) {
		...
		bookExistance_groupBox->Controls->Add(existance_radioButton2);
		   ...
		   // Œ·‡·ÓÚ˜ËÍ ‰Îˇ ÍÌÓÔÍË ‰Ó·‡‚ÎÂÌËˇ
		   // ¬ ‰‡ÌÌÓÏ Ó·‡·ÓÚ˜ËÍÂ Â‡ÎËÁÓ‚‡Ì‡ ÎÓ„ËÍ‡ ‰Ó·‡‚ÎÂÌËˇ Ó·˙ÂÍÚ‡ ‚ ¡ƒ
	private: System::Void addToDb_button_Click(System::Object^ sender, System::EventArgs^ e) {
		// ÔËÒ‚‡Ë‚‡ÌËÂ ÔÂÂÏÂÌÌ˚Ï ÁÌ‡˜ÂÌËÈ ËÁ ÚÂÍÒÚÓ‚˚ı ÔÓÎÂÈ
		...
		// ÔËÒ‚‡Ë‚‡ÌËÂ ÔÂÂÏÂÌÌÓÈ-Ï‡ÍÂÛ Ó Ì‡ÎË˜ËË/ÓÚÒÛÚÒÚ‚ËË ÁÌ‡˜ÂÌËˇ ‚ Á‡‚ËÒËÏÓÒÚË ÓÚ ‚˚·‡ÌÌÓ„Ó ÍÓÏÔÓÌÂÌÚ‡ RadioButton
	...
	private: System::Void bookName_textBox_TextChanged(System::Object^ sender, System::EventArgs^ e) {
		   ...
		   // Œ·‡·ÓÚ˜ËÍ ‰Îˇ ÍÌÓÔÍË Ó˜ËÒÚÍË ÚÂÍÒÚÓ‚˚ı ÔÓÎÂÈ
		   // œË Ì‡Ê‡ÚËË Ì‡ ‰‡ÌÌÛ˛ ÍÌÓÔÍÛ ‚ÒÂ ÚÂÍÒÚÓ‚˚Â ÔÓÎˇ Ó˜Ë˘‡˛ÚÒˇ
